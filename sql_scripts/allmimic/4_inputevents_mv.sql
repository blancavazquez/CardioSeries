--- Script for extracting information of table of inputevents_mv for STEMI patients

drop view all_inputevents_mv;
create view all_inputevents_mv as
...
order by int_mv.subject_id;
\copy (SELECT * FROM all_inputevents_mv) to '/tmp/INPUTEVENTS_mv.csv' CSV HEADER;
drop view all_inputevents_mv;
