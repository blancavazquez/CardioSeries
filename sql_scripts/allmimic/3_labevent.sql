--- Script for extracting information of table of labevents for STEMI patients
drop view all_labevents;
create view all_labevents as
...
order by lab.subject_id;
\copy (SELECT * FROM all_labevents) to '/tmp/LABEVENTS.csv' CSV HEADER;
drop view all_labevents;
