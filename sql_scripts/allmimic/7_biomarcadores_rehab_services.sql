...
drop view rehab_services_troponin_temp1 cascade;
create view rehab_services_troponin_temp1 as
...
drop view rehab_services_ckmb_temp1 cascade;
create view rehab_services_ckmb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view rehab_services_ck_temp1 cascade;
create view rehab_services_ck_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view rehab_services_mb_temp1 cascade;
create view rehab_services_mb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view biomarcadores_rehab_services_stemi cascade;
create view biomarcadores_rehab_services_stemi as
...
,"VALUE"
,"VALUEUOM"
from rehab_services_troponin_temp1
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from rehab_services_ckmb_temp1
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from rehab_services_mb_temp1
order by "SUBJECT_ID";

--select * from biomarcadores_rehab_services_stemi;
