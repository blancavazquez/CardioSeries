...
--**********************************************************************************
drop view nursing_other_troponin_temp1 cascade;
create view nursing_other_troponin_temp1 as
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,tropo
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(tropo::text,'{',''),'}',''),':',''),'" 0"','0'),'/',''),'"',''),'-',''),' ',''),'0,0','0'),'x','')::double precision as value
...
drop view nursing_other_ckmb_temp1 cascade;
create view nursing_other_ckmb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view nursing_other_ck_temp1 cascade;
create view nursing_other_ck_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,ck
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(ck::text,'{',''),'}',''),':',''),'"',''),'/',''),' ',''),'x','')as value--::double precision as value
      ,REPLACE(REPLACE(fecha::text,'{"[**',''),'**]','') as fecha2  
      ,hora 
...
drop view nursing_other_mb_temp1 cascade;
create view nursing_other_mb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,mb0,mb
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(mb::text,'{',''),'}',''),':',''),'"',''),'/',''),' ',''),',','.'),'(',''),'>',''),'-',''),'x','')as value--::double precision as value
      ,REPLACE(REPLACE(fecha::text,'{"[**',''),'**]','') as fecha2  
      ,hora 
...
drop view biomarcadores_nursing_other_stemi cascade;
create view biomarcadores_nursing_other_stemi as
...
,"VALUE"
,"VALUEUOM"
from nursing_other_troponin_temp1
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from nursing_other_ckmb_temp1 --ok
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from nursing_other_ck_temp1 --ok
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from nursing_other_mb_temp1 --ok
where "VALUE">0
order by "SUBJECT_ID";

--select * from biomarcadores_nursing_other_stemi;
