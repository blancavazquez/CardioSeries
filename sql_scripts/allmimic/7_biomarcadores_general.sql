...
drop view general_troponin_temp1 cascade;
create view general_troponin_temp1 as
...
select nt.subject_id
      ,nt.hadm_id
      ,nt.chartdate
      ,REPLACE(REPLACE(tropo::text,'{',''),'}','')::double precision as value
...
drop view general_troponin_temp2 cascade;
create view general_troponin_temp2 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,tropo
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(tropo::text,'{',''),'}',''),':',''),'" 0"','0'),'/',''),'4-8','4')::double precision as value
      ,REPLACE(REPLACE(fecha::text,'{"[**',''),'**]','') as fecha2  
      ,hora 
...
drop view general_ckmb_temp1 cascade;
create view general_ckmb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,ckmb
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(ckmb::text,'{',''),'}',''),':',''),'"',''),'/',''),' ',''),'4-8','4')::double precision as value
      ,REPLACE(REPLACE(fecha::text,'{"[**',''),'**]','') as fecha2  
      ,hora 
...
drop view general_ck_temp1 cascade;
create view general_ck_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,ck
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(ck::text,'{',''),'}',''),':',''),'"',''),'/',''),' ',''),'4-8','4')as value--::double precision as value
      ,REPLACE(REPLACE(fecha::text,'{"[**',''),'**]','') as fecha2  
      ,hora 
...
drop view general_mb_temp1 cascade;
create view general_mb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,mb0,mb
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(mb::text,'{',''),'}',''),':',''),'"',''),'/',''),' ',''),'4-8','4')as value--::double precision as value
      ,REPLACE(REPLACE(fecha::text,'{"[**',''),'**]','') as fecha2  
      ,hora 
...
drop view biomarcadores_general_stemi cascade;
create view biomarcadores_general_stemi as
...
,"VALUE"
,"VALUEUOM"
from general_mb_temp1
order by "SUBJECT_ID";

--select * from biomarcadores_general_stemi;
