...
select nt.subject_id
      ...
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(
            REPLACE(REPLACE(mb::text,'{',''),'}',''),':',''),'"',''),'/',''),' ',''),'`',''),';','')as value--::double precision as value
      ,REPLACE(REPLACE(fecha::text,'{"[**',''),'**]','') as fecha2  
      ,hora 
...
,"VALUE"
,"VALUEUOM"
from nursing_troponin_temp1 --ok
UNION
select
"SUBJECT_ID"
,"HADM_ID"
