...
drop view STEMI_vent_class;
create view STEMI_vent_class as
select
...
\copy (SELECT * FROM STEMI_vent_class) to '/tmp/STEMI_vent_class.csv' CSV HEADER;
...
drop view STEMI_vent_itemid;
create view STEMI_vent_itemid as
with temp_vent as
(
select 
   vt.icustay_id
...
\copy (SELECT * FROM STEMI_vent_itemid) to '/tmp/VENTILATION.csv' CSV HEADER;
