...
--***********************************************************************************
--Regex: glucose
drop view glucose_nutrition_st cascade;
create view glucose_nutrition_st as
...
drop view glucose_finger_nutrition_st cascade;
create view glucose_finger_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
------------------------------------
Regex: bun
drop view bun_nutrition_st cascade;
create view bun_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
-------------------------------------
--Regex: creatinine
drop view creatinine_nutrition_st cascade;
create view creatinine_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
------------------------------------------
--Regex sodium
drop view sodium_nutrition_st cascade;
create view sodium_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
-------------------------------------
--Regex: potassium
drop view potassium_nutrition_st cascade;
create view potassium_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
-------------------------------------------
--Regex: chloride
drop view chloride_nutrition_st cascade;
create view chloride_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
--------------------------------------
--Regex: totalCO2 (tco2)
drop view total_co2_nutrition_st cascade;
create view total_co2_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
-------------------------------
--Regex: PO2 arterial 
drop view po2_arterial_nutrition_st cascade;
create view po2_arterial_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view pco2_arterial_nutrition_st cascade;
create view pco2_arterial_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
-----------------------------------------
--Regex: ph
drop view ph_nutrition_st cascade;
create view ph_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
------------------------------------------
--Regex: co2
drop view co2_nutrition_st cascade;
create view co2_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
---------------------------------
--Regex: albumin
drop view albumin_nutrition_st cascade;
create view albumin_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view calcium_nutrition_st cascade;
create view calcium_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
---------------------------------------
--Regex: phosphorus
drop view phosphorus_nutrition_st cascade;
create view phosphorus_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
-------------------------------------
--Regex: magnesium
drop view magnesium_nutrition_st cascade;
create view magnesium_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view alkaline_phosphate_nutrition_st cascade;
create view alkaline_phosphate_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view ast_nutrition_st cascade;
create view ast_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
---------------------------------------
--Regex_ amylase
drop view amylase_nutrition_st cascade;
create view amylase_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view total_bilirubin_nutrition_st cascade;
create view total_bilirubin_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
--------------------------------------
--Regex: wbc
drop view wbc_nutrition_st cascade;
create view wbc_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
--------------------------------------
--regex: hemoglobin
drop view hgb_nutrition_st cascade;
create view hgb_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
--------------------------------------
--regex: hematocrit
drop view hematocrit_nutrition_st cascade;
create view hematocrit_nutrition_st as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view laboratorio_nutrition_stemi cascade;
create view laboratorio_nutrition_stemi as
...
,"VALUE"
,"VALUEUOM"
from glucose_finger_nutrition_st--ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from creatinine_nutrition_st--ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from potassium_nutrition_st--ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from total_co2_nutrition_st--ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from po2_arterial_nutrition_st --ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from pco2_arterial_nutrition_st --ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from phosphorus_nutrition_st --ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from magnesium_nutrition_st --ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from alkaline_phosphate_nutrition_st --ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from total_bilirubin_nutrition_st --ok
UNION ALL
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from hematocrit_nutrition_st --ok
order by "SUBJECT_ID";

--select * from laboratorio_nutrition_stemi;
