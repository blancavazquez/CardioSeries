...
drop view consult_troponin_temp1 cascade;
create view consult_troponin_temp1 as
...
drop view consult_ckmb_temp1 cascade;
create view consult_ckmb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view consult_ck_temp1 cascade;
create view consult_ck_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view consult_mb_temp1 cascade;
create view consult_mb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view biomarcadores_consult_stemi cascade;
create view biomarcadores_consult_stemi as
...
,"VALUE"
,"VALUEUOM"
from consult_mb_temp1
order by "SUBJECT_ID";

--select * from biomarcadores_consult_stemi;
