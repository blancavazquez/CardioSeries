...
--1) from phy notes
drop view physician_troponin cascade;
create view physician_troponin as
...
--*****************regex 1
drop view physician_temp1_troponin cascade;
create view physician_temp1_troponin as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
--**********************regex 2
create view physician_temp2_troponin as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view  physician_troponin_regex cascade;
create view  physician_troponin_regex as
...
drop view nursing_troponin cascade;
create view nursing_troponin as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view nursing_other_troponin cascade;
create view nursing_other_troponin as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view general_troponin cascade;
create view general_troponin as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view rehab_services_troponin cascade;
create view rehab_services_troponin as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view consult_troponin cascade;
create view consult_troponin as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view discharge_troponin cascade;
create view discharge_troponin as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view troponin_data cascade;
create view troponin_data as
...
,"VALUE"
,"VALUEUOM"
from discharge_troponin
order by "SUBJECT_ID";

select * from troponin_data;
