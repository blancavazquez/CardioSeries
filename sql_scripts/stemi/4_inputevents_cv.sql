--- Script for extracting information of table of inputevents_cv for STEMI patients

drop view STEMI_inputevents_cv;
create view STEMI_inputevents_cv as
...
order by int_cv.subject_id;
\copy (SELECT * FROM STEMI_inputevents_cv) to '/tmp/INPUTEVENTS_CV.csv' CSV HEADER;
drop view STEMI_inputevents_cv;
