...
drop view nursing_troponin_temp1 cascade;
create view nursing_troponin_temp1 as
...
drop view nursing_ckmb_temp1 cascade;
create view nursing_ckmb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view nursing_ck_temp1 cascade;
create view nursing_ck_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view nursing_mb_temp1 cascade;
create view nursing_mb_temp1 as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view biomarcadores_nursing_stemi cascade;
create view biomarcadores_nursing_stemi as
select
"SUBJECT_ID"
,"HADM_ID"
,"CHARTDATE"
...
,"VALUE"
,"VALUEUOM"
from nursing_mb_temp1
order by "SUBJECT_ID";

--select * from biomarcadores_nursing_stemi;
