...
drop view physician_troponin_temp1_nstemi cascade;
create view physician_troponin_temp1_nstemi as
...
drop view physician_troponin_temp2_nstemi cascade;
create view physician_troponin_temp2_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,tropo
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(tropo::text,'{',''),'}',''),':',''),'" 0"','0'),'/',''),',',''),'"','')::double precision as value
      ,REPLACE(REPLACE(fecha::text,'{"[**',''),'**]','') as fecha2  
      ,hora 
...
drop view physician_ckmb_temp1_nstemi cascade;
create view physician_ckmb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view physician_ck_temp1_nstemi cascade;
create view physician_ck_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view physician_mb_temp1_nstemi cascade;
create view physician_mb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,mb0,mb
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(mb::text,'{',''),'}',''),':',''),'"',''),'/',''),' ','')as value--::double precision as value
      ,REPLACE(REPLACE(fecha::text,'{"[**',''),'**]','') as fecha2  
      ,hora 
...
drop view biomarcadores_physician_nstemi cascade;
create view biomarcadores_physician_nstemi as
...
,"VALUE"
,"VALUEUOM"
from physician_troponin_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from physician_troponin_temp2_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from physician_ckmb_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from physician_ck_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from physician_mb_temp1_nstemi
order by "SUBJECT_ID";

--select * from biomarcadores_physician_nstemi;
