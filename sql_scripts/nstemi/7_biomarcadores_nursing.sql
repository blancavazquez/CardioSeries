...
drop view nursing_troponin_temp1_nstemi cascade;
create view nursing_troponin_temp1_nstemi as
...
select nt.subject_id
      ...
      ,nt.chartdate
      ,tropo
      ,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(tropo::text,'{',''),'}',''),':',''),'"',''),'/','')::double precision as value
...
drop view nursing_ckmb_temp1_nstemi cascade;
create view nursing_ckmb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view nursing_ck_temp1_nstemi cascade;
create view nursing_ck_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view nursing_mb_temp1_nstemi cascade;
create view nursing_mb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view biomarcadores_nursing_nstemi cascade;
create view biomarcadores_nursing_nstemi as
select
"SUBJECT_ID"
,"HADM_ID"
,"CHARTDATE"
...
,"VALUE"
,"VALUEUOM"
from nursing_troponin_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from nursing_ckmb_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from nursing_mb_temp1_nstemi
order by "SUBJECT_ID";

--select * from biomarcadores_nursing_nstemi;
