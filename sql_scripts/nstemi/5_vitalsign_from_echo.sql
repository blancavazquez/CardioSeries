...
drop view echo_height_ns;
create view echo_height_ns as
...
drop view echo_weight_ns;
create view echo_weight_ns as
with temp_value as --extract values from echo notes
(
select
  nt.subject_id
...
drop view echo_sysbp_ns;
create view echo_sysbp_ns as
with temp_value as --extract values from echo notes
(
select
  nt.subject_id
...
drop view echo_diasbp_ns;
create view echo_diasbp_ns as
with temp_value as --extract values from echo notes
(
select
  nt.subject_id
...
drop view echo_heart_rate_ns;
create view echo_heart_rate_ns as
with temp_value as --extract values from echo notes
(
select
  nt.subject_id
...
drop view echo_join_ns;
create view echo_join_ns as
...
,"itemid"
,"value"
from echo_heart_rate_ns
order by subject_id;

--*******************************
--Paso 7: add valueom
drop view echo_data_ns cascade;
create view echo_data_ns as
select
