...
drop view rehab_services_troponin_temp1_nstemi cascade;
create view rehab_services_troponin_temp1_nstemi as
...
drop view rehab_services_ckmb_temp1_nstemi cascade;
create view rehab_services_ckmb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view rehab_services_ck_temp1_nstemi cascade;
create view rehab_services_ck_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view rehab_services_mb_temp1_nstemi cascade;
create view rehab_services_mb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view biomarcadores_rehab_services_nstemi cascade;
create view biomarcadores_rehab_services_nstemi as
...
,"VALUE"
,"VALUEUOM"
from rehab_services_troponin_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from rehab_services_ckmb_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from rehab_services_ck_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from rehab_services_mb_temp1_nstemi
order by "SUBJECT_ID";

--select * from biomarcadores_rehab_services_nstemi;
