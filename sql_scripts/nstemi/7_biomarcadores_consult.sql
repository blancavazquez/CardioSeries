...
drop view consult_troponin_temp1_nstemi cascade;
create view consult_troponin_temp1_nstemi as
...
drop view consult_ckmb_temp1_nstemi cascade;
create view consult_ckmb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view consult_ck_temp1_nstemi cascade;
create view consult_ck_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view consult_mb_temp1_nstemi cascade;
create view consult_mb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view biomarcadores_consult_nstemi cascade;
create view biomarcadores_consult_nstemi as
...
,"VALUE"
,"VALUEUOM"
from consult_troponin_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from consult_ckmb_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from consult_mb_temp1_nstemi
order by "SUBJECT_ID";

--select * from biomarcadores_consult_nstemi;
