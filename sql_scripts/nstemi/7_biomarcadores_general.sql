...
drop view general_troponin_temp1_nstemi cascade;
create view general_troponin_temp1_nstemi as
...
drop view general_troponin_temp2_nstemi cascade;
create view general_troponin_temp2_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view general_ckmb_temp1_nstemi cascade;
create view general_ckmb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view general_ck_temp1_nstemi cascade;
create view general_ck_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view general_mb_temp1_nstemi cascade;
create view general_mb_temp1_nstemi as
with temp_note_sin_saltos as
(
select nt.subject_id
      ,nt.hadm_id
...
drop view biomarcadores_general_nstemi cascade;
create view biomarcadores_general_nstemi as
...
,"VALUE"
,"VALUEUOM"
from general_troponin_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from general_troponin_temp2_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from general_ckmb_temp1_nstemi
UNION
select
"SUBJECT_ID"
,"HADM_ID"
...
,"VALUE"
,"VALUEUOM"
from general_mb_temp1_nstemi
order by "SUBJECT_ID";

--select * from biomarcadores_general_nstemi;
